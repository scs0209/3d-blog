export default function Loading() {
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50'>
      ...
      {/* Core sphere */}
      <div
        className='absolute w-15 h-15 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full 
      ...
      {/* Ring 1 */}
      <div
        className='absolute w-full h-full border-2 border-cyan-400/70 rounded-full 
      ...
      {/* Ring 2 */}
      <div
        className='absolute w-30 h-30 top-4 left-4 border-2 border-cyan-400/50 rounded-full 
                   shadow-[0_0_15px_rgba(0,234,255,0.3)] [transform-style:preserve-3d]
      ...
      {/* Ring 3 */}
      <div
        className='absolute w-24 h-24 top-8 left-8 border-2 border-cyan-400/30 rounded-full 
                   shadow-[0_0_15px_rgba(0,234,255,0.3)] [transform-style:preserve-3d]
