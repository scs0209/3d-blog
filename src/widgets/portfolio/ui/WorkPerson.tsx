...
export function WorkPerson({ animationType = 'default', ...props }: any) {
  const group = useRef<three.Group>(null);
  const { nodes, materials, animations } = useGLTF('/touchScreen.glb');
      ...
      <group name='Scene'>
        ...
        <group name='Armature' rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <skinnedMesh
            ...
            geometry={(nodes.Cylinder_Pele_0 as three.SkinnedMesh)?.geometry}
...
useGLTF.preload('/touchScreen.glb');
