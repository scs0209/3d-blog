...
export const AnimatedLink = ({ href, children, target, rel, className = '' }: AnimatedLinkProps) => {
  return (
    <a
      ...
      target={target}
      rel={rel}
      className={`flex items-center gap-1.5 hover:text-cyan-100 transition-colors relative 
        before:absolute before:-bottom-1 before:left-0 before:w-full before:h-0.5 before:bg-cyan-300 
