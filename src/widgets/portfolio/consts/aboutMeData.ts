  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        '개발 과정에서 생기는 불편함을 줄이는 데 관심이 많고, 성능·DX·자동화처럼 팀이 더 편하게 일할 수 있는 구조를 만드는 일을 좋아합니다.',
        'React와 TypeScript를 중심으로 제품 안정화와 기술 부채 해소에 집중하고 있습니다.',
      ],
    },
    {
      key: 'background',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '개인 블로그/포트폴리오에서는 FSD 구조와 React Three Fiber, AI 요약·PR 자동화 등을 실험하며 제품 감각을 다듬고 있습니다.',
      ],
    },
    {
      key: 'hobbies',
