...
export const COSMOS_PORTALS: readonly CosmosPortal[] = [
  {
    ...
    label: 'Blog',
    href: '/blog',
    description: 'Thoughts from the edge — notes, experiments, and quiet orbits.',
    cta: 'Explore',
    position: [-9.5, -0.12, -9],
    radius: 4.8,
    accent: '#3de8ff',
  ...
  },
  {
    ...
    label: 'Portfolio',
    href: '/portfolio',
    description: 'Stations built along the way — work that still glows.',
    cta: 'Enter',
    position: [9.5, -0.12, -9],
    radius: 4.8,
    accent: '#ff9a3c',
  ...
  },
  {
    ...
    label: 'About',
    href: '/portfolio',
    description: 'The traveler behind this horizon.',
    cta: 'Enter',
    position: [0, -0.12, -23],
    radius: 5.2,
    accent: '#c070ff',
